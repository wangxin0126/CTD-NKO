...
def main(args: DictConfig):
    ...
    # init model
    # model = instantiate(args.model, dataset_collection=dataset_collection, config=args)
    ...
    # log_data_seed(dataset_collection, args, logger=logger)
    ...
    # print(torch.load(best_checkpoint_path)['state_dict'])
